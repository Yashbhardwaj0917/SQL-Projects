...
/* Total Cases vs Total Deaths Shows likelihood of death if contracted covid in my country (USA) */
...
/* Rerun SELECT * for the Deaths file to search for errors. I notice some rows were showing continent is null, with the continent name in the location column instead. 
...
/* Countries with Highest Death Count per Population (CORRECTED) Rerun query with WHERE is not null clause */
...
/* I noticed results were calculating incorrect numbers. EX. North America was not adding Canada numbers. I noticed results were displaying misc categories instead of continent. 
Ex : European Union is part of Europe and incomes are not locations. This is fixed by adding WHERE continent is NULL, WHERE locations are not, and grouping by location instead of continent. 
